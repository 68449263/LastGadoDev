...
public class AutoCompleteTextInputAdapter extends BaseAdapter implements Filterable {
    ...
    public AutoCompleteTextInputAdapter(Context context, int resource, String[] objects, String headerText) {
